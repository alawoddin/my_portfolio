...
const Home = () => {
  ...
  const [addcategory, setLatestCategory] = useState(null);

  useEffect(() => {
    fetch("http://127.0.0.1:8000/api/categories")
      .then(res => res.json())
      .then(data => setLatestCategory(data));
  }, []);
  ...
  <h1 className="home__title">
    Hi,<br />
    I'am <span className="home__title-color">
        {addcategory?.name}
        </span><br />Web Designer</h1>
  ...
  <a href="#" className="button">Contact</a>
    ...
    <div className="home__img">
      <svg className="home__blob" viewBox="0 0 479 467" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <g mask="url(#mask0)">
          <path d="M9.19024 145.964C34.0253 76.5814 114.865 54.7299 184.111 29.4823C245.804 6.98884 311.86 -14.9503 370.735 14.143C431.207 44.026 467.948 107.508 477.191 174.311C485.897 237.229 454.931 294.377 416.506 344.954C373.74 401.245 326.068 462.801 255.442 466.189C179.416 469.835 111.552 422.137 65.1576 361.805C17.4835 299.81 -17.1617 219.583 9.19024 145.964Z" />
          <image className="home__blob-img" x={50} y={60} href="./public/img/perfil.png" />
        </g>
      </svg>
    </div>
  </section>
  ...
  <section className="skills section" id="skills">
    ...
    <div className="skills__container bd-grid">          
      ...
      <div>              
        <img src="./public/img/work3.jpg" alt className="skills__img" />
      </div>
    </div>
  </section>
  {/*===== WORK =====*/}
  <section className="work section" id="work">
    ...
    <div className="work__container bd-grid">
      ...
      <a href className="work__img">
        <img src="./public/img/work2.jpg" alt />
      </a>
      <a href className="work__img">
        <img src="./public/img/work3.jpg" alt />
      </a>
      <a href className="work__img">
        <img src="./public/img/work4.jpg" alt />
      </a>
      <a href className="work__img">
        <img src="./public/img/work5.jpg" alt />
      </a>
      <a href className="work__img">
        <img src="./public/img/work6.jpg" alt />
      </a>
    </div>
  </section>
  {/*===== CONTACT =====*/}
